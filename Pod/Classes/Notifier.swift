...
internal struct Notifier {
  static func notifyDidSendBodyData(_ bytesSent: Int64, totalBytesSent: Int64, totalBytesExpectedToSend: Int64) {
    ...
    sendNotification(notification: .didSendBodyData, params: params)
  }
}

extension Notifier {
  fileprivate static func sendNotification(notification: CustomHttpHeadersNotification, params: Any?) {
